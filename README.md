...
This project defaults to webpack for local development because Turbopack on Next 16.2.2 is currently panicking in this environment. If you want to retest Turbopack later, run:
